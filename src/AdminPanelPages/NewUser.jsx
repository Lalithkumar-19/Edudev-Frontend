      ...
      <form className="newUserForm">
        <div className="newUserContainer">
          <div className="newUserItem">
            ...
            <input type="text" placeholder="John Doe" name="name" value={data.name} required onChange={handleChange} />
          </div>
          <div className="newUserItem">
            <label>Email</label>
            <input type="email" placeholder="john@example.com" name="email" value={data.email} onChange={handleChange} required />
          </div>
          <div className="newUserItem">
            <label>Password</label>
            <input type="password" placeholder="********" name="password" value={data.password} onChange={handleChange} required />
          </div>
          ...
          <button className="newUserButton" type="button" onClick={handle_Create_User}>
            Create User
          </button>
        </div>
      </form>
